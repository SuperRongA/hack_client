...
object FDPClient {
    ...
    // Client information
    const val CLIENT_NAME = "RongKing"
    const val COLORED_NAME = "§7[§b§lRongKing§7] "
    const val CLIENT_CREATOR = "e"
    const val CLIENT_WEBSITE = "github.RongKing.com"
    ...
    private fun checkUpdate() {
        try {
            val get = HttpUtils.get("https://api.github.com/repos/SkidderMC/FDPClient/commits/newt")
